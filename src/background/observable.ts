...
// export const PREBEING = Symbol();
// export type Prebeing = typeof PREBEING;
...
// export function peek<T>(ob: ObservableCore<T>): T | Prebeing {
//   let value: T | Prebeing = PREBEING;
//   ob.observe((val) => { value = val; })();
//   return value;
// }
